...
- **[Docker for Beginners](https://docker-curriculum.com/)** — practical introduction to Docker workflows
- **[How to configure NGINX as a reverse proxy on Ubuntu 22.04](https://www.digitalocean.com/community/tutorials/how-to-configure-nginx-as-a-reverse-proxy-on-ubuntu-22-04)** — reverse proxy patterns
- **[WordPress sample (Docker)](https://docs.docker.com/samples/wordpress/)** — WordPress, PHP, and MariaDB/MySQL in Compose
- **[Dockerfile best practices](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/)** — leaner, safer images

### Use of artificial intelligence

- **Role of AI** — Artificial Intelligence tools (such as ChatGPT) were used as a learning support tool, not as a replacement for understanding or implementation.
- **Concept clarification** — To better understand core topics such as Docker architecture, containerization, networking, volumes, and the role of each service (NGINX, WordPress, MariaDB).
- **Troubleshooting (when stuck)** — When encountering blocking issues (e.g., container communication problems, configuration errors, or service startup failures), AI was used to explore possible causes and debugging approaches.
- **Guidance, not solutions** — The AI provided explanations and directions, but all configurations, scripts, and implementation details were written, tested, and validated manually.
- **Outcome** — This approach ensured that AI acted as a mentor-like assistant, helping reinforce learning while maintaining full control and understanding of the project.
